...
routes.get('/transactions', () => {})                                           //consulda de uma transacoes pela ref ou intervalo de datas
routes.get('/transactions/:transaction', () => {})                              //consulta de uma transacao pelo seu codigo
